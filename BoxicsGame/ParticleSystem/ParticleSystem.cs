...
// Slightly Modified by Patrick Kongpinda
#endregion
...
namespace BoxicsGame.ParticleSystem
{
    /// <summary>
    ...
    public abstract class ParticleSystem
    {
        ...
        protected void LoadContent()
        {
            ...
            // load the texture....
            texture = ParticleTextures.Get(textureFilename);
        ...
        public void AddParticles(Vector2 where)
        {
            ...
            int numParticles = BoxicsGame.Random.Next(minNumParticles, maxNumParticles);
        ...
        protected virtual void InitializeParticle(Particle p, Vector2 where)
        {
            ...
            float velocity =
                Helper.RandomBetween(minInitialSpeed, maxInitialSpeed);
            float acceleration =
                Helper.RandomBetween(minAcceleration, maxAcceleration);
            float lifetime =
                Helper.RandomBetween(minLifetime, maxLifetime);
            float scale =
                Helper.RandomBetween(minScale, maxScale);
            float rotationSpeed =
                Helper.RandomBetween(minRotationSpeed, maxRotationSpeed);
        ...
        {
            float angle = Helper.RandomBetween(0, MathHelper.TwoPi);
